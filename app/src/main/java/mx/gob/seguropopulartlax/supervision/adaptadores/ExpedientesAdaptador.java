...
public class ExpedientesAdaptador extends RecyclerView.Adapter<ExpedientesAdaptador.VariablesViewHolder> {

    ArrayList<VariablesPOJO> variables;
    public Activity activty;

    public ExpedientesAdaptador(ArrayList<VariablesPOJO> variables, Activity activity){
    ...
    @NonNull
    @Override
    public ExpedientesAdaptador.VariablesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ExpedientesAdaptador.VariablesViewHolder variablesViewHolder, final int position) {
